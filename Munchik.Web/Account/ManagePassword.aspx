<%@ Page Title="Manage Password" Language="C#" MasterPageFile="~/SiteAuthentication.Master" AutoEventWireup="true" CodeBehind="ManagePassword.aspx.cs" Inherits="Munchik.Web.Account.ManagePassword" %>
                                            ...
                                            <div class="form-group">
                                                <div class="col-md-offset-2 col-md-10">
                                                    <asp:Button runat="server" Text="Change Password" ValidationGroup="ChangePassword" OnClick="ChangePassword_Click" CssClass="btn btn-default" />
                                                      <asp:HyperLink runat="server" Text="Cancel" CssClass="btn btn-default"  ID="cancel"/>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
