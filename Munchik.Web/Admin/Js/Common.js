...
function SuccessNotification(heading, message) {
...
function WarningNotification(heading, message) {
    // alert('helllo');
    toastr.info(message, heading, {
        "positionClass": "toast-bottom-center",
        timeOut: 5000,
...
function CA_MakeRequestG(WBurl, WBData, SuccessCB, FailedCB, vAsync) {
    var pAsync = true;
    if (vAsync != undefined) { pAsync = vAsync; }
    $.ajax({
