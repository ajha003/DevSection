<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Company_CreateCustomer.aspx.cs" Inherits="Munchki.Web.Admin.Company_CreateCustomer" MasterPageFile="~/Admin/Admin.Master" %>
                        ...
                        <div class="form-validation">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtName" ForeColor="#ef5350" ValidationGroup="valCard" ErrorMessage="*Required" SetFocusOnError="true"></asp:RequiredFieldValidator>
                                </div>
                            </div>
