<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Gadget_Manage.aspx.cs" Inherits="Munchki.Web.Admin.Gadget_Manage" MasterPageFile="~/Admin/Admin.Master" %>
                        ...
                        <div class="form-validation">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <asp:Label CssClass="col-lg-4 col-form-label" runat="server" ID="Label1">Type </asp:Label>&nbsp;&nbsp;

                                    <asp:CheckBox ID="chkOwner" runat="server" />
                                    <asp:Label CssClass="col-lg-4 col-form-label" runat="server" ID="Label2">Owner </asp:Label>&nbsp;&nbsp;
        ...
        <div class="row">
            <div class="col-12">
                        ...
                        <div class="table-responsive m-t-40">
                            <table id="tblSearch" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                    ...
                                    <HeaderTemplate>
                                        <thead>
                                            <tr>
                                                ...
                                                <th>
                                                    <asp:LinkButton ID="lnkMake" CssClass="header" runat="server"><b>Make</b></asp:LinkButton>
                                                </th>
                                                <th>
                                                    <asp:LinkButton ID="lnkModel" CssClass="header" runat="server"><b>Model</b></asp:LinkButton>
                                                </th>
                                                <th>
                                    ...
                                    <ItemTemplate>
                                        <tbody>
                                            <tr>
                                                ...
                                                <td><%#DataBinder.Eval(Container.DataItem, "Make")%></td>
