<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Company_Edit.aspx.cs" Inherits="Munchki.Web.Admin.Company_Edit" MasterPageFile="~/Admin/Admin.Master" %>
                            ...
                            <div class="form-group row justify-content-center">
                                ...
                                <div class="col-lg-6">
                                    <asp:TextBox ID="txtName" runat="server" CssClass="form-control" />
                                         <asp:RequiredFieldValidator ID="reqchk" runat="server" ForeColor="#ef5350" ControlToValidate="txtName" ValidationGroup="valCard" ErrorMessage="*Required" SetFocusOnError="true"></asp:RequiredFieldValidator>
